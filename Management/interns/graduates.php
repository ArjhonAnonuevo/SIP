...
$sql = "SELECT 
        ...
        WHERE 
            server_status.interns_status = 'graduated'
...
$totalRecords = $connection->query("SELECT COUNT(*) AS total FROM server_status WHERE interns_status = 'graduated'")->fetch_assoc()['total'];
